package com.danzhao.controller.aop;
...
public class PageInterceptor {
	 ...
	 * 
	* @Title: process   
	* @Description: (把所有controller后面带有Paging的方法加上分页功能)  
	* 规定：方法后面两个必须是 当前页和每页数量 
	* @realization: (AOP编程)
	* @author: cx
	* @param point
	* @return
	* @throws Throwable
	 */
    @Around("execution(* com.danzhao.controller..*.*Paging(..))")
