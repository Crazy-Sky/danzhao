...
<html>
  <head>
	...
	<script type="text/javascript" src="static/js/countScore/countScore.js"></script>

  </head>
   <body>
    <div class="centercontent">
    	<div class="pageheader">
	    	<h1 class="pagetitle">考生成绩统计界面   &nbsp; 当前考场：${sessionScope.user.ername}</h1>
	    	<span class="pagedesc">成绩统计</span>
        </div>
         	...
         	<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
				<thead>
					<tr>
						...
						<th class="head1">总成绩</th>
					</tr>
				</thead>
				<tbody id="exatedStuTabs">
					<!-- <tr>
						<td>1</td>
						<td>43067676767</td>
						<td>李四</td>
