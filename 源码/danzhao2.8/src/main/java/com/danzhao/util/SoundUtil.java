...
/** * �������йصĹ����� * * @author liqiang4j */
 public class SoundUtil{
	 /** * 将WAV格式的音频文件转换为PCM格式的文件 * * @param wavFilePath * WAV文件路径 * @throws UnsupportedAudioFileException * @throws IOException */
	 public static void wavToPcm(String wavFilePath){
		 ...
		 AudioInputStream targetAudioInputStream = AudioSystem.getAudioInputStream(AudioFormat.Encoding.ULAW, sourceAudioInputStream); 
	 ...
	 public static String getWavFormat(String wavFilePath){
		 File wavFile = new File(wavFilePath); 
		 AudioInputStream ais; String result = "";
		 try{ 
	...
	public static void main(String[] args){
		System.out.println(SoundUtil.getWavFormat("e://test.wav"));
